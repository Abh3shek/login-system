...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $email = $_POST["login-floatingEmail"];
    ...
    <section class="login-form">
        <div class="card px-0 py-2">
            <div class="card-body">
                ...
                <form action="/login-system/welcome.php" method="post">
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" id="login-floatingEmail" placeholder="name@example.com" name="login-floatingEmail" />
                        <label for="login-floatingEmail">Email address</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="password" class="form-control" id="login-floatingPassword" placeholder="Password" name="login-floatingPassword" />
